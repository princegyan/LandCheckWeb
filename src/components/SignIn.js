...
function SignIn() {
  ...
  return (
    <div>
        <>
                  <div
                    className="w-[65vw]justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
                  >
                    <div className="w-[35vw] relative my-3 mx-auto max-w-3xl">
                      {/*content*/}
                      <div className="pr-10 pl-10 pb-5 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        {/*header*/}
